 ...
 * @author Jose
 */
public class TesteExponencial implements Testeable {
    ...
    public TesteExponencial(List numerosATestear, int cantidadIntervalos, float media) {
    ...
    public Intervalos[] generarTablaFrecuenciasGeneral(float diferencia, float inicial) {
        ...
        for (int j = 0; j < cantidadIntervalos; j++) {
            ...
            tablaFrencuencias[j].calcularFeExponencial(media, cantidadNumeros);
        }
